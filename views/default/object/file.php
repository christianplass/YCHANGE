...
/**
 * File renderer.
 * NB! This is an override for the view from the "file" plugin
 *
 * @package ElggFile
 */
...
if ($full && !elgg_in_context('gallery')) {
	...
	// OVERRIDE: Made sure full view triggers download on file icon being clicked
	$file_icon = elgg_view_entity_icon($file, 'small', array(
